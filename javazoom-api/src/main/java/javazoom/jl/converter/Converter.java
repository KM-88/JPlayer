...
public class Converter {
	...
	public void convert(String sourceName, String destName, ProgressListener progressListener,
	...
	public synchronized void convert(InputStream sourceStream, String destName, ProgressListener progressListener,
			Decoder.Params decoderParams) throws JavaLayerException {
	...
	public interface ProgressListener {
		...
		/**
		 * Conversion is complete. Param1 contains the time to convert in milliseconds.
		 * Param2 contains the number of MPEG audio frames converted.
		 */
		 ...
		 *
		 * @param updateID Code indicating the information that has been updated.
		 *
		 ...
		 *
		 *                 UPDATE_FRAME_COUNT: param1 is the frame count, or -1 if not
		 *                 known. UPDATE_CONVERT_COMPLETE: param1 is the conversion
		 *                 time, param2 is the number of frames converted.
		 */
		void converterUpdate(int updateID, int param1, int param2);

		/**
		 * If the converter wishes to make a first pass over the audio frames, this is
		 * called as each frame is parsed.
		 */
		void parsedFrame(int frameNo, Header header);

		/**
		 * This method is called after each frame has been read, but before it has been
		 * decoded.
		 *
	...
	/**
	 * Implementation of <code>ProgressListener</code> that writes notification text
	 * to a <code>PrintWriter</code>.
	 */
