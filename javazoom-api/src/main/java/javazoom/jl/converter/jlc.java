...
/**
 * The <code>jlc</code> class presents the JavaLayer Conversion functionality as
...
public class jlc {
	...
	static class jlcArgs {
		...
		public boolean processArgs(String[] argv) {
			...
			while (i < argc) {
				...
				if (argv[i].charAt(0) == '-') {
					...
					/*
					 * else if (argv[i].equals("-f")) { if (++i == argc) {
					 * System.out.println("Please specify a new scalefactor after the -f option!");
					 * System.exit(1); } ma.use_own_scalefactor = true; // ma.scalefactor = argv[i];
					 * }
					 */
					else
						return Usage();
		...
		public boolean Usage() {
			...
			/*
			 * System.out.
			 * println("  -f ushort  use this scalefactor instead of the default value 32768"
			 * );
			 */
			return false;
		}
