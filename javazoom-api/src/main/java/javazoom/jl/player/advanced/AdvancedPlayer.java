...
public class AdvancedPlayer {
	...
	public boolean play(int frames) throws JavaLayerException {
		...
		while (frames-- > 0 && ret && !isPaused) {
			ret = decodeFrame();
		}

		System.out.println("Remianing :" + frames);
		if (!isPaused) {
	...
	/**
	 * Pausing by setting isPaused status to True. Reset to False to continue
	 */
